...
export const post = {
  "h1": "Endoscopia Digestiva Alta em Recife: Guia Completo para Pacientes | Clínica Okazaki",
  "faqs": [
    {
      "a": "A endoscopia não causa dor porque o paciente recebe sedação endovenosa antes do procedimento. A sedação proporciona relaxamento profundo e a maioria das pessoas não se lembra do exame. Além disso, aplica-se anestésico local na garganta para reduzir o desconforto. Após o exame, pode haver leve irritação na garganta que desaparece em poucas horas. O procedimento é seguro e bem tolerado quando realizado por equipe experiente.",
      "q": "A endoscopia digestiva alta dói?"
    },
    {
      "a": "O procedimento endoscópico em si dura entre 5 e 15 minutos, dependendo da complexidade de cada caso e da necessidade de biópsias ou procedimentos adicionais. Entretanto, o tempo total na clínica é maior, incluindo o preparo pré-exame (cerca de 20 a 30 minutos) e o período de recuperação após a sedação (30 a 60 minutos). Recomenda-se reservar aproximadamente 2 a 3 horas para todo o processo, desde a chegada até a liberação.",
      "q": "Quanto tempo dura o exame de endoscopia?"
    },
    {
      "a": "Não. Devido à sedação utilizada durante o exame, é absolutamente contraindicado dirigir veículos nas 12 horas seguintes ao procedimento. Os medicamentos sedativos afetam temporariamente os reflexos, coordenação motora e capacidade de julgamento, mesmo que o paciente se sinta completamente desperto. É obrigatório comparecer ao exame acompanhado de adulto responsável que possa conduzi-lo para casa. Também se recomenda evitar tomar decisões importantes ou operar máquinas nesse período.",
      "q": "Posso dirigir após fazer endoscopia?"
    },
    {
      "a": "A frequência de repetição da endoscopia depende dos achados do exame anterior e da condição clínica de cada paciente. Para exames normais sem alterações significativas, geralmente não há necessidade de repetição de rotina, exceto se surgirem novos sintomas. Condições como esôfago de Barrett, metaplasia intestinal ou pólipos podem exigir vigilância endoscópica a cada 1 a 3 anos. Pacientes com histórico de câncer ou lesões pré-malignas têm protocolos específicos de seguimento. O gastroenterologista determinará o intervalo adequado para cada caso individualmente.",
      "q": "Com que frequência devo repetir a endoscopia?"
    },
    {
      "a": "A endoscopia é um procedimento muito seguro quando realizado por profissionais experientes. Complicações são raras, ocorrendo em menos de 0,1% dos casos. Os riscos mais comuns incluem reações aos medicamentos sedativos, sangramento leve após biópsias (que geralmente cessa espontaneamente) e pequenas lesões na mucosa. Complicações graves como perfuração ou sangramento importante são extremamente raras. A Clínica Okazaki segue rigorosamente todos os protocolos de segurança e mantém estrutura para manejo de intercorrências, minimizando ainda mais os riscos do procedimento.",
      "q": "Quais são os riscos da endoscopia digestiva alta?"
    },
    {
      "a": "A maioria dos medicamentos de uso contínuo pode ser mantida, mas essa decisão deve ser individualizada. Medicações para pressão arterial e doenças cardíacas geralmente são mantidas com pequeno gole de água. Anticoagulantes (varfarina, rivaroxabana) e antiagregantes plaquetários (clopidogrel, aspirina) podem necessitar suspensão ou ajuste de dose, especialmente se há planejamento de biópsias. Antidiabéticos orais e insulina requerem orientações específicas. É fundamental informar todos os medicamentos em uso ao agendar o exame e seguir as orientações médicas fornecidas.",
      "q": "Preciso suspender meus medicamentos antes da endoscopia?"
    }
  ],
  "lead": "A endoscopia digestiva alta é um dos exames mais importantes para diagnóstico e tratamento de doenças do sistema digestivo. Neste guia completo, você entenderá como funciona o procedimento, quando é indicado, como se preparar adequadamente e o que esperar durante e após o exame na Clínica Okazaki em Recife.",
  "slug": "endoscopia-digestiva-alta-recife-guia-completo",
  "about": "procedimento",
  "title": "Endoscopia Digestiva Alta em Recife: Guia Completo para Pacientes | Clínica Okazaki",
  "author": {
  ...
  "pillar": "endoscopia",
  "excerpt": "Entenda tudo sobre endoscopia digestiva alta: indicações, preparo, procedimento e cuidados pós-exame na Clínica Okazaki em Recife.",
  "eyebrow": "BLOG · ENDOSCOPIA",
  "keywords": "endoscopia digestiva alta, endoscopia Recife, esofagogastroduodenoscopia, exame de endoscopia, preparo para endoscopia, gastroenterologia Recife, Clínica Okazaki",
  "sections": [
    {
      "h2": "O Que É a Endoscopia Digestiva Alta",
      "id": "o-que-e-endoscopia-digestiva-alta",
      "blocks": [
        {
          "type": "p",
    ...
    {
      "h2": "Principais Indicações para Realizar o Exame",
      "id": "principais-indicacoes",
      "blocks": [
        {
          "type": "p",
        ...
        },
        {
          "type": "ul",
          "items": [
            "Dor abdominal alta persistente ou recorrente que não melhora com tratamento clínico",
            "Azia frequente e refluxo gastroesofágico que não respondem adequadamente à medicação",
            "Dificuldade para engolir (disfagia) ou sensação de alimento parado na garganta",
            "Náuseas e vômitos persistentes sem causa aparente",
            "Perda de peso não intencional associada a sintomas digestivos",
            "Sangramento digestivo, manifestado por vômitos com sangue ou fezes escurecidas",
            "Anemia por deficiência de ferro sem causa identificada",
            "Histórico familiar de câncer gástrico ou esofágico"
          ]
        },
        {
          "type": "p",
    ...
    {
      "h2": "Como Se Preparar Adequadamente para a Endoscopia",
      "id": "preparo-adequado",
      "blocks": [
        {
          "type": "p",
        ...
        },
        {
          ...
          "items": [
            ...
            "Carteira do convênio médico ou documentação para particular",
            "Pedido médico original da endoscopia",
            "Exames anteriores relacionados ao sistema digestivo",
            "Lista atualizada de todos os medicamentos em uso",
            "Acompanhante adulto e responsável é obrigatório"
          ]
        },
        {
          "type": "p",
    ...
    {
      "h2": "Como Funciona o Procedimento na Clínica Okazaki",
      "id": "como-funciona-procedimento",
      "blocks": [
        {
          "type": "p",
        ...
        },
        {
          "href": "/endoscopia",
          "type": "link",
          "label": "Para informações sobre outros procedimentos endoscópicos disponíveis na Clínica Okazaki, visite nossa página sobre endoscopia"
        },
        {
          "type": "h3",
    ...
    {
      "h2": "Cuidados Importantes Após a Endoscopia",
      "id": "cuidados-pos-exame",
      "blocks": [
        {
          "type": "p",
        ...
        },
        {
          "type": "ul",
          "items": [
            "Evite atividades físicas intensas no dia do exame",
            "Não consuma bebidas alcoólicas nas 24 horas seguintes",
            "Evite trabalhos que exijam atenção plena ou responsabilidade no mesmo dia",
            "Não assine documentos importantes até o dia seguinte",
            "Mantenha repouso relativo e evite esforços excessivos"
          ]
        },
        {
          "type": "h3",
    ...
    {
      "h2": "Por Que Escolher a Clínica Okazaki para Sua Endoscopia em Recife",
      "id": "por-que-escolher-clinica-okazaki",
      "blocks": [
        {
          "type": "p",
  ...
  "updatedAt": "2026-04-30T12:00:00.860Z",
  "description": "Guia completo sobre endoscopia digestiva alta em Recife: preparo, procedimento, cuidados e quando fazer. Equipe especializada e tecnologia de ponta na Clínica Okazaki.",
  "publishedAt": "2025-05-20T10:30:00-03:00",
  "breadcrumbLabel": "Endoscopia Digestiva Alta"
} satisfies BlogPost;
